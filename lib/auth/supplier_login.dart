import 'package:ecommerce/Screen/supplier%20Screen/suplier_home_screen.dart';
import 'package:ecommerce/Widgets/auth_widgets.dart';
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      HaveAccount(
                        ...
                        actionLabel: 'Sign Up',
                        onPressed: () {
                          Get.offAll(() => const SupplierRegister());
                        },
                      ),
                      processing == true
                          ? const Center(
